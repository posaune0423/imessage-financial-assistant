...
- Return iMessage-safe text only. Avoid structural Markdown. Prefer short bold labels and a small number of meaningful emoji when they improve scanability.
